    ...
    lessons: [
        {
            lesson: 1,
            idioms: [
                { idiom: "Cut somebody some slack", meaning: "To be less critical of someone; to not judge someone severely.", example: "I know he's late, but let's cut him some slack—the traffic is terrible today.", story: "This phrase likely comes from the world of sailing ships on the ocean. A 'slack' rope is a loose one. To 'cut some slack' meant to loosen a rope, easing the tension on the ship's sails, which is a good metaphor for easing the pressure on a person." },
                { idiom: "A dime a dozen", meaning: "Something that is very common and of little value.", example: "Don't worry about that lost pen; they're a dime a dozen.", story: "In the late 1800s in the United States, many common goods like apples or eggs literally cost a dime ($0.10 is called a dime) for a dozen (12 of something is called a dozen) so it was only ten cents for 12 of them. The phrase stuck to mean anything that is common and inexpensive." },
